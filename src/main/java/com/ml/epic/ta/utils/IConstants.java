...
public interface IConstants {
	...
	public interface AwsAthena {
		...
		// count(1) FROM elb_logs_orc Where elb_response_code = '200' GROUP BY
		// elb_name ORDER BY 2 DESC limit 10";
	...
	public interface AwsTransaltor {

		public static final String DEFAULT_SOURCE_LANG = "en";
	}
